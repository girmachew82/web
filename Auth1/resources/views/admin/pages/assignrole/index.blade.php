...
<div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            ...
            <a href="{{ url('admin/pages/asignrole/Assign') }}"><i class="fas fa-plus"></i>Add</a>
            </button>
          </div>
        </div>
               <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->department_name }}</td>
                         ...
                         <td> @foreach ($assignedroles as $assignedrole)
                            {{ $assignedrole->role_name }}
                           @endforeach
                        </td>
                        <td><!-- Button trigger modal -->
                            <a data-action="{{ route('assignRole', $user->id) }}"
                            data-toggle="modal" data-target="#assignRoleModal{{ $user->id }}">
                              <i class="fa fa-pen"></i>
                            </a>

                        <!-- Modal -->
                        <div class="modal fade" id="assignRoleModal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="assignRoleModallLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="assignRoleModallLabel">Assign role</h5>
                             ...
                             Assign role to  {{ $user->givenname }} <br>
