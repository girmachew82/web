...
<div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            ...
            <a href="{{ url('admin/pages/role/AddRole') }}"><i class="fas fa-plus"></i>Add</a>
            </button>
          </div>
        </div>
               <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $no++ }}</td>
                        <td>{{ $role->name }}</td>
                        <td><a href="{{ url('admin/pages/role/EditRole').'/'.$role->id }}">
                            <i class="fa fa-edit"></i></a>&nbsp;

    <!-- Button trigger modal -->
    <a data-action="{{ route('deleteRole', $role->id) }}"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       Are you sure to delete? <br/>{{ $role->name }}
      </div>
