...
<div class="card">
        <div class="card-header">
          <h3 class="card-title">Adding institute</h3>
       ...
       <div class="card-body">
            <form action="{{ route('addInstitute') }}" method="post">
                @csrf
                ...
                <input type="text" class="form-control" name ='institute' placeholder="Enter institute" required pattern="[a-zA-Z\s]+">
